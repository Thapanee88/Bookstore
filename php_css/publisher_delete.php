...
if(isset($_POST["publisher_id"]) && !empty($_POST["publisher_id"])){
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        // Set parameters
        $param_publisher_id = trim($_POST["publisher_id"]);
    ...
    if(empty(trim($_GET["publisher_id"]))){
...
<body>
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-5 mb-3">Delete Publisher</h2>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger">
                            <input type="hidden" name="publisher_id" value="<?php echo trim($_GET["publisher_id"]); ?>"/>
